...
BOOST_CLASS_EXPORT_IMPLEMENT(solidEarth);
BOOST_CLASS_EXPORT_IMPLEMENT(Air);
BOOST_CLASS_EXPORT_IMPLEMENT(Slope);
BOOST_CLASS_EXPORT_IMPLEMENT(Room);
BOOST_CLASS_EXPORT_IMPLEMENT(Hall);
